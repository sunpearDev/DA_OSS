...
const Price = props => {
        if (props.price == 0)
            return ( < div className = "Price" > FREE < /div>)
                        ...
                        return ( < div className = "Price" > { props.price }
                            $ < /div>)
                            else return ( < div className = "Price" >
                                <
                                div className = "discount" > -{ props.discount } < /div> <
                                div className = "origin" > { props.price }
                                $ < /div> <
                                div className = "sale" > { Math.round((1 - props.discount / 100) * parseInt(props.price) * 100) / 100 }
                                $ <
                                /div> < /
                                div > )
                        }
                    ...
                    export default class GameDetailPage extends Component {
                        ...
                        render() {
                                return ( <
                                        ...
                                        frameBorder = { 0 }
                                        allow = "accelerometer; disablekb; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowFullScreen / >
                                        <
                                        /div> {
                                        this.state.images.map(image => ( < div key = { image } > < img src = { "https://res.cloudinary.com/amadas/image/upload/v1607146111/" + image }
                                                alt = "" / > < /div>))} < /
                                                Carousel > <
                                                div className = "intro" >
                                                <
                                                ...
                                                div className = "buy_zones" > {
                                                    ...
                                                    ( < button className = "download" > Dowload <
                                                        div className = "dropdown" > {
                                                            this.state.download_link.map(link => ( < a key = { link }
                                                                    href = { link }
                                                                    ...
                                                                    this.state.Minimum ? ( < > < div > OS < /div> <
                                                                        ...
                                                                        div > RAM < /div> <
                                                                        div > { this.state.Minimum.Memory }
                                                                        GB < /div> <
                                                                        div > Storage Space < /div> <
                                                                        div > { this.state.Minimum.Storage }
                                                                        GB < /div></ > ) :
                                                                ...
                                                                this.state.Recommended ? ( < > < div > OS < /div> <
                                                                    ...
                                                                    div > RAM < /div> <
                                                                    div > { this.state.Recommended.Memory }
                                                                    GB < /div> <
                                                                    div > Storage Space < /div> <
                                                                    div > { this.state.Recommended.Storage }
                                                                    GB < /div></ > ) :
