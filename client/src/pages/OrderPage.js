            ...
            return ( <
                ...
                div > {
                    this.state.game.price === 0 ? ( < >
                        ...
                        /div> <
                        /div> <
                        div className = "note" > Please send money one of payment to get your game and wait 24 h. < /div> <
                        div className = "note" > Contact admin
                        if your game have issues. < /div> <
                        />)} <
                        /div> <
                        div >
                        <
                        ...
                        div className = "row1" >
                        <
                        img src = { "/images/" + (Array.isArray(this.state.game.images) === true ? (this.state.game.images[0]) : (this.state.game.images)) }
                        alt = "" / >
                        <
                        div > { this.state.game.name } < /div> <
                        div > Price < /div> <
                        div > { this.state.game.price }
                        $ < /div> <
                        div > Discount < /div> <
                        ...
                        <
                        div > Total < /div> <
                        div > { this.state.game.price * (100 - this.state.game.discount) / 100 }
                        $ < /div> <
                        /div> <
